# Numerical Claim Detection Project Upgraded
...
- train:
  ...
  - claim-plus-FinBERT baseline using the frozen Stage 1 materiality score and FinBERT tone signals
...
`stage3_amplitude`
- derives an amplitude target from absolute next-day return
- trains market-only, structured logistic-regression, and structured MLP baselines
- writes `outputs/metrics/stage3_amplitude_summary.json`
